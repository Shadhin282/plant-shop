...
//     // console.log("clicked")
//     if (console.log(event.target.tagName == 'BUTTON')) {
...
function showProducts() {
    // console.log("Product is showing.")
    for (let product of products) {
        // console.log(product)
        const productCart = document.createElement("div");
        productCart.innerHTML = `<div class="card bg-base-100 shadow-sm product-card">
    ...
    `;
        document.getElementById("product-container").append(productCart)
    }
